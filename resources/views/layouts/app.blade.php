...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-links mt-2">
            @if(auth()->user()->role === 'doctor')
                {{-- Doctor: Dashboard goes to their workspace --}}
                <a href="/doctor/dashboard" class="{{ Request::is('doctor/dashboard*') ? 'active' : '' }}">
                    <i class="fas fa-th-large"></i> Dashboard
                </a>

                <div class="px-4 mt-4 mb-2"><small class="text-uppercase text-muted fw-bold"
                        style="font-size: 0.7rem; letter-spacing: 1px;">Clinical Tools</small></div>
                <a href="/doctor/records"
                    class="{{ Request::is('doctor/records*') || Request::is('doctor/consultation*') ? 'active' : '' }}">
                    <i class="fas fa-file-medical-alt"></i> Medical Records
                </a>
            @else
                {{-- Admin / Receptionist: normal dashboard --}}
                <a href="/"
                    class="{{ Request::is('/') || Request::is('admin/dashboard*') || Request::is('receptionist/dashboard*') ? 'active' : '' }}">
                    <i class="fas fa-th-large"></i> Dashboard
                </a>

                @if(auth()->user()->role === 'admin')
                    <div class="px-4 mt-4 mb-2"><small class="text-uppercase text-muted fw-bold"
                            style="font-size: 0.7rem; letter-spacing: 1px;">Administration</small></div>
                ...
                <div class="px-4 mt-4 mb-2"><small class="text-uppercase text-muted fw-bold"
                        style="font-size: 0.7rem; letter-spacing: 1px;">Patient Care</small></div>
    ...
    <div class="main-content">
                    ...
                    <div class="dropdown">
                        <div class="d-flex align-items-center cursor-pointer" data-bs-toggle="dropdown">
                            ...
                            <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"
                                style="width: 45px; height: 45px; font-weight: 700; font-size: 1.2rem; box-shadow: 0 4px 6px rgba(99, 102, 241, 0.2);">
                                {{ substr(Auth::user()->name, 0, 1) }}
                            </div>
                        </div>
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg p-2 mt-3"
                            style="border-radius: 1rem; min-width: 200px;">
                            <li><a class="dropdown-item rounded-3 py-2" href="/profile"><i
                                        class="fas fa-user-edit me-2 text-primary"></i> Edit Profile</a></li>
                            <li>
        ...
        <div class="container-fluid p-4 p-md-5 animate__animated animate__fadeIn">
            @if(session('success'))
                <div class="alert alert-success alert-dismissible border-0 shadow-sm fade show mb-4 py-3 px-4 rounded-4"
                    role="alert">
            ...
            @if(session('error'))
                <div class="alert alert-danger alert-dismissible border-0 shadow-sm fade show mb-4 py-3 px-4 rounded-4"
                    role="alert">
                    <div class="d-flex align-items-center">
